...
public class AnvilRecipe implements IAnvilRecipe {
    ...
    public static class Serializer implements RecipeSerializer<AnvilRecipe> {
        ...
        public AnvilRecipe fromJson(ResourceLocation id, JsonObject json) {
            var result = AACraftingHelper.getItemStack(GsonHelper.getAsJsonObject(json, "result"), true, true);
            ...
            for (var input : GsonHelper.getAsJsonArray(json, "inputs")) {
                ...
                returnItems.add(input.getAsJsonObject().has("return") ? AACraftingHelper.getItemStack(GsonHelper.getAsJsonObject(input.getAsJsonObject(), "return"), true, false) : ItemStack.EMPTY);
                nbt.add(input.getAsJsonObject().has("nbt") ? AACraftingHelper.getNBT(input.getAsJsonObject().get("nbt")) : new CompoundTag());
