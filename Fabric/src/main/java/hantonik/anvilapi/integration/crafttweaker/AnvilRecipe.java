...
public final class AnvilRecipe {
        ...
        CraftTweakerAPI.apply(new IRuntimeAction() {
            ...
            public void apply() {
                AARecipeHelper.getRecipes()
                        .getOrDefault(AARecipeTypes.ANVIL, Maps.newHashMap())
                        .values().stream()
    ...
    public static void removeRecipe(String id) {
        CraftTweakerAPI.apply(new IRuntimeAction() {
            @Override
            public void apply() {
                AARecipeHelper.getRecipes().get(AARecipeTypes.ANVIL).remove(new ResourceLocation(AnvilAPI.MOD_ID, id));
            }
    ...
    public static void removeRecipe(String modId, String id) {
        CraftTweakerAPI.apply(new IRuntimeAction() {
            @Override
            public void apply() {
                AARecipeHelper.getRecipes().get(AARecipeTypes.ANVIL).remove(new ResourceLocation(modId, id));
            }
