...
public final class AnvilRepairRecipe {
    ...
    public static void removeRecipe(String id) {
        CraftTweakerAPI.apply(new IRuntimeAction() {
            @Override
            public void apply() {
                AARecipeHelper.getRecipes(AARecipeTypes.ANVIL_REPAIR.get()).remove(new ResourceLocation(AnvilAPI.MOD_ID, id));
            }
    ...
    public static void removeRecipe(String modId, String id) {
        CraftTweakerAPI.apply(new IRuntimeAction() {
            @Override
            public void apply() {
                AARecipeHelper.getRecipes(AARecipeTypes.ANVIL_REPAIR.get()).remove(new ResourceLocation(modId, id));
            }
